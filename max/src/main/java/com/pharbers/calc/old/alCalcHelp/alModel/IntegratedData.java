package com.pharbers.calc.old.alCalcHelp.alModel;
...
import com.pharbers.common.datatype.string.PhStringOpt;
...
public class IntegratedData extends BaseExcel implements Serializable {
    ...
    public String sortConditions1() {return yearAndmonth.toString() + hospNum.toString() + PhStringOpt.removeSpace(minimumUnitCh.toString());}
