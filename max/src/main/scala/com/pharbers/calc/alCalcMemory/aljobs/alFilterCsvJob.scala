...
import com.pharbers.calc.alCalcMemory.aljobs.alJobs.max_filter_csv_jobs._
import com.pharbers.calc.alCalcMemory.alprecess.alprecessdefines.alPrecessDefines.{do_map, restore_data}
