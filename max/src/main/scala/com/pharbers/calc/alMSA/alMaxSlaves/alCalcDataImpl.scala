...
import com.pharbers.calc.alCalcHelp.alFinalDataProcess.alBsonPath
import com.pharbers.calc.alCalcHelp.alModel.IntegratedData
import com.pharbers.calc.alCalcHelp.alModel.westMedicineIncome
import com.pharbers.calc.alCalcHelp.{alSegmentGroup, alShareData}
...
import com.pharbers.calc.alCalcMemory.aljobs.alJobs.{common_jobs, worker_core_calc_jobs}
