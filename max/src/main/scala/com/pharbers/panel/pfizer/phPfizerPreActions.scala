...
case class phPfizerPreActions(temp_name: String) {
    ...
    val product_match_file: String = match_dir + "pfizer/pfizer匹配表.xlsx"
    val markets_match_file: String = match_dir + "pfizer/通用名市场定义.xlsx"
    val universe_file: String = match_dir + "pfizer/universe_麻醉市场_online.xlsx"
    val not_published_hosp_file: String = match_dir + "pfizer/2017年未出版医院名单.xlsx"
    val fill_hos_data_file: String = match_dir + "pfizer/补充医院.xlsx"
            ...
            new choiceJob{
                ...
                val actions: List[pActionTrait] = existenceRdd("full_hosp_file") ::
                    ...
                    new sequenceJob {
                        ...
                        override val actions: List[pActionTrait] =
                            xlsxReadingAction[phPfizerCpaFormat](fill_hos_data_file, "full_hosp_file") ::
