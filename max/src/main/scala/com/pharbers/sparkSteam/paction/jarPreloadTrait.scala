...
class jarPreloadTrait extends pActionTrait { //this : pFileSystem =>
    ...
    lazy val lst =  ("commons-codec-1.5.jar", "./jar/commons-codec-1.5.jar") ::
                    ("dom4j-1.1.jar", "./jar/dom4j-1.1.jar") ::
                    ("xmlbeans-2.3.0.jar", "./jar/xmlbeans-2.3.0.jar") ::
                    ("poi-3.8.jar", "./jar/poi-3.8.jar") ::
                    ("poi-ooxml-3.8.jar", "./jar/poi-ooxml-3.8.jar") ::
                    ("poi-ooxml-schemas-3.8.jar", "./jar/poi-ooxml-schemas-3.8.jar") ::
                    ("pharbers-max-0.1.jar", "/home/spark/.m2/repository/com/pharbers/pharbers-max/0.1/pharbers-max-0.1.jar") :: Nil
