...
class PfizerPanelSuite extends FunSuite {
    ...
    test("pfizer generate panel"){
        ...
        val result = phPfizerPanelJob("/mnt/config/Client/pfizer/1705 CPA.xlsx", "/mnt/config/Client/pfizer/1705 GYC.xlsx", "201705", "URO").perform().asInstanceOf[MapArgs].get("phSavePanelJob").get
